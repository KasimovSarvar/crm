...
urlpatterns = [
    ...
    path('amdin_lead_list/<int:pk>/', admin_lead_view, name='admin-lead-list'),
    path('lead_update/<int:pk>/', lead_update_view, name='lead-update'),
    path('create_student/<int:pk>/', create_student_view, name='create-student'),
